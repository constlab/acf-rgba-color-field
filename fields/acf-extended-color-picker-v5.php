	...
	class acf_field_extended_color_picker extends acf_field {
		...
		*/
		...
		public function input_admin_enqueue_scripts() {
			...
			wp_enqueue_script( 'wp-color-picker-alpha', "{$url}/assets/js/wp-color-picker-alpha.min.js", [ 'wp-color-picker' ], '1.2.2', true );
			...
			wp_register_script( 'acf-extended-color-picker-script', "{$url}/assets/js/acf-extended-color-picker.js", [ 'wp-color-picker-alpha' ], $version, true );
